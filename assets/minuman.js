const MINUM =[
    ...
    {
        id: 2,
        img: require ('./airputih.jpg'),
        name: 'Air Putih',
        desc: 'Anda haus ? mungkin anda harus coba ini air putih qbs hadir dalam bentuk saset dengan harga gratis apabila anda telah mendaftarkan diri anda menjadi santri qbs',
        harga: 'Gratis'
    },
    {
        id: 3,
